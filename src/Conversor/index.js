...
//https://free.currconv.com/api/v7/convert?q=USD_BRL&compact=ultra&apiKey=be6a26fd0f2cc60eecc0
...
class Conversor extends Component{
  ...
  async converter(){
    ...
    const response = await api.get (`convert?q=${de_para}&compact=ultra&apiKey=be6a26fd0f2cc60eecc0`);
